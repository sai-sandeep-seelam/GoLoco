 ...
 * Set VITE_API_BASE_URL in the Azure Static Web Apps build environment variables
 ...
 *
 * Vite replaces import.meta.env.VITE_API_BASE_URL at build time, so no runtime
...
if (!API_BASE_URL) {
  throw new Error(
    '[GoLoco] VITE_API_BASE_URL is not defined. ' +
